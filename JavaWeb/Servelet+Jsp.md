...
![BS结构系统的通信原理2](mdimg/BS结构系统的通信原理2-16629010991911.png)
...
![BS结构系统的角色和协议](mdimg/BS结构系统的角色和协议-16629011831143.png)
...
## 1.3开发一个带有Servlet（Java小程序）的webapp（重点）
...
- 思考：我们自己new的Servlet对象受WEB容器的管理吗？
  ...
  - ![WEB容器中的Map集合](mdimg/WEB容器中的Map集合-16629015404375.png)
